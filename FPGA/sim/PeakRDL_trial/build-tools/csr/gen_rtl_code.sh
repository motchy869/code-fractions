...
CSR_RTL_FILE_NAME=${RDL_FILE_NAME%.*}.sv
CSR_RTL_FILE_PATH=$RTL_DIR/$CSR_RTL_FILE_NAME
...
UVM_REG_MODEL_RTL_FILE_NAME=${RDL_FILE_NAME%.*}_uvm_reg_model_pkg.svh
UVM_REG_MODEL_RTL_FILE_PATH=$RTL_DIR/$UVM_REG_MODEL_RTL_FILE_NAME
