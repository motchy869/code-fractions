...
generate
    ...
    if (if_csr_side.BYTE_ADDR_BIT_WIDTH != BYTE_ADDR_BIT_WIDTH) begin: gen_invalid_BYTE_ADDR_BIT_WIDTH
        ...
        nonexistent_module_to_throw_a_custom_error_message_for_invalid_BYTE_ADDR_BIT_WIDTH inst();
    end
    ...
    if (if_ram_side.WORD_ADDR_BIT_WIDTH != WORD_ADDR_BIT_WIDTH) begin: gen_invalid_WORD_ADDR_BIT_WIDTH
        ...
        nonexistent_module_to_throw_a_custom_error_message_for_invalid_WORD_ADDR_BIT_WIDTH inst();
    end
endgenerate
// --------------------
