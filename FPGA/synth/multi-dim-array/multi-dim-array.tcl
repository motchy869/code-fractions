...
#
# multi-dim-array.tcl: Tcl script for re-creating project 'multi-dim-array'
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/hdl/main_pkg.sv"]"\
 "[file normalize "$origin_dir/hdl/main.sv"]"\
 "[file normalize "$origin_dir/hdl/main_tb.sv"]"\
  ]
  foreach ifile $files {
  ...
  set paths [list \
 "[file normalize "$origin_dir/[file normalize "$origin_dir/../../../Digilent-vivado-library"]"]"\
   D:/workspace/genPur/common \
  ]
  foreach ipath $paths {
...
set _xil_proj_name_ "multi-dim-array"
...
set script_file "multi-dim-array.tcl"
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/../../../Digilent-vivado-library"] D:/workspace/genPur/common" $obj
...
set file "$origin_dir/hdl/main_pkg.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/hdl/main.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
...
set file "$origin_dir/hdl/main_tb.sv"
set file [file normalize $file]
