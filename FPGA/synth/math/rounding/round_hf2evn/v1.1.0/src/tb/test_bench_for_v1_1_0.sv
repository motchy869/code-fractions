...
//! test bench for round_hf2evn_v1_1_0
module test_bench_for_v1_1_0();
// ---------- parameters ----------
...
// ---------- types ----------
typedef virtual interface round_hf2evn_v1_1_0_if #(
    .N(N),
    .N_F(N_F)
) dut_vif_t;
// --------------------
...
interface round_hf2evn_v1_1_0_if #(
