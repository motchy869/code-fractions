...
generate
    ...
    if (MULT_INPUT_STG_PIPELINE_DEPTH < 1) begin: gen_mult_input_stg_pipeline_depth_validation
        nonexistent_module_to_throw_a_custom_error_message_for_invalid_mult_input_stg_pipeline_depth inst();
    end

    if (MULT_OUTPUT_STG_PIPELINE_DEPTH < 1) begin: gen_mult_output_stg_pipeline_depth_validation
        nonexistent_module_to_throw_a_custom_error_message_for_invalid_mult_output_stg_pipeline_depth inst();
    end
