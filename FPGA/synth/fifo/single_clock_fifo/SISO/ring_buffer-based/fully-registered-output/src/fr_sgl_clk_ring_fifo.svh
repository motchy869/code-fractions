`ifndef FB_SGL_CLK_RING_FIFO_SVH_INCLUDED
`define FB_SGL_CLK_RING_FIFO_SVH_INCLUDED
...
extern module fr_sgl_clk_ring_fifo #(
...
`endif // FB_SGL_CLK_RING_FIFO_SVH_INCLUDED
