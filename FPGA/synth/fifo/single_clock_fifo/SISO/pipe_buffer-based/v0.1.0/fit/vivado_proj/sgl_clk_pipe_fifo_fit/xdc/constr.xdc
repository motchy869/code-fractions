...
##RGB LED 6
set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports { LED_RGB[2] }]; #IO_L18P_T2_34 Sch=led6_r
set_property -dict { PACKAGE_PIN F17   IOSTANDARD LVCMOS33 } [get_ports { LED_RGB[1] }]; #IO_L6N_T0_VREF_35 Sch=led6_g
set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports { LED_RGB[0] }]; #IO_L8P_T1_AD10P_35 Sch=led6_b
set_output_delay -clock sys_clk_pin -max 1.0 [get_ports { LED_RGB }]; # dummy delay
set_output_delay -clock sys_clk_pin -min 0.0 [get_ports { LED_RGB }]; # dummy delay
set_false_path -from * -to [get_ports { LED_RGB }];
