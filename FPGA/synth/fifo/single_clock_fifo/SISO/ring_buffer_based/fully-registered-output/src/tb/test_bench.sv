...
`include "../fr_sgl_clk_ring_fifo.svh"

`default_nettype none

// timescale is defined in Makefile.

//! A test bench for fr_sgl_clk_ring_fifo.
module test_bench;
// ---------- parameters ----------
...
// ---------- types ----------
typedef virtual interface fr_sgl_clk_ring_fifo_if#(
...
interface fr_sgl_clk_ring_fifo_if#(
    parameter int DATA_BIT_WIDTH = 8, //! data bit width
...
fr_sgl_clk_ring_fifo_if#(
    .DATA_BIT_WIDTH(DATA_BIT_WIDTH),
    .DEPTH(DEPTH)
) dut_if (.i_clk(r_clk));

//! DUT instance
fr_sgl_clk_ring_fifo#(
    .DATA_BIT_WIDTH(DATA_BIT_WIDTH),
    .DEPTH(DEPTH)
) dut (
    .i_clk(r_clk),
