...
//! This module only supports single-shot access (does not support burst access), but this is enough in most cases (such as CSR).
module my_avmm_agt_sgl_shot_acc_template_v0_1_0 #(
